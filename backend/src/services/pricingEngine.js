  ...
  return source
    .map((item, index) => {
      ...
      return {
        ...
        aspectRatio: toNumber(item.aspectRatio, widthCm > 0 && heightCm > 0 ? widthCm / heightCm : 0),
        points,
        estimatedPointsMin: toInt(item.estimatedPointsMin, 0),
        estimatedPointsMax: toInt(item.estimatedPointsMax, 0),
        densityPerCm2: toNumber(item.densityPerCm2, 0),
        colorCount: toInt(item.colorCount, 0),
        complexity: item.complexity || null,
        programComplexity: item.programComplexity || item.complexity || null,
        ...
        analysisMethod: compactString(item.analysisMethod),
